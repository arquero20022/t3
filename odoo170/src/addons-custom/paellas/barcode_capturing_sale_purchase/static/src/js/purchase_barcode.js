...
export class PurchaseBarcodeController extends FormController {
    setup() {
        super.setup();
        const button = this.el.querySelector('.barcode_scan_button_purchase');
        if (button) {
            button.addEventListener('click', this.onBarcodeScan.bind(this));
        }
...
FormController.include(PurchaseBarcodeController);