...
export class SaleBarcodeController extends FormController {
    setup() {
        super.setup();
        const button = this.el.querySelector('.barcode_scan_button_sale');
        if (button) {
...
FormController.include(SaleOrderBarcodeController);
